...
export default function RoyalBankUk() {
  const handleLogOut = () => {
    fire.auth().signOut();
  };
    ...
    >
      ...
      <div className="row">
        ...
        <div className="logs">
          ...
          <div className="row chaseBankHeading">Royal Bank Scotia Logs</div>
          <div className="row">
            <div className="col-md-6 col-lg-6">
              <p className="logsHeading">Royal Bank Scotia Company Logs</p>
